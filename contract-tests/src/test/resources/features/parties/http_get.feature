Feature: This feature is used by Switch to interact with, to findout in which FSP (payee FSP) the required party (payee) is located.
  ...
  Scenario Outline: Lookup Participants
